...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand" href="#">Questão 04</a>
            ...
            <div class="card card-info">
                ...
                <form name="form_consumo" id="form_consumo" action="" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="velocida" class="col-sm-2 col-form-label">Velocidade em m/s</label>
                        <div class="col-sm-10">
                        <input type="number" min="1" class="form-control" id="velocidade" name="velocidade" placeholder="Ex.: 4,5 m/s" required>
                        </div>
                    </div>
